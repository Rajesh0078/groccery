    ...
    return (
        <>
            <form className='text-left flex flex-col mt-4' onSubmit={submitHandler}>
                ...
                <input className='w-[100%] py-2 px-2 rounded-md border cursor-pointer border-slate-300 bg-gradient-to-r from-[orangered] text-white to-orange-400' type="submit" value={"Login"} />
